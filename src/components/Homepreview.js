  ...
  return (
    <Link to={`/room/${roomID}`} className='flex justify-start'>
      ...
      <div className='ml-4 mr-6 grid grid-col flex-grow'>
        <h2 className='text-light-title font-bold text-normal'>
          {roomName || 'Folu Abiola'}
        </h2>
        <p className='row-span-2 truncate whitespace-pre-wrap text-light-text text-[10px] h-6 leading-[0.75rem]'>
          {roomPath ||
            'Review PR and set up tasks for the new week? Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem veritatis a, laudantium illum non blanditiis optio tempora nihil quam at! Review PR and set up tasks for the new week? Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem veritatis a, laudantium illum non blanditiis optio tempora nihil quam at!'}
        </p>
      </div>
